...
class ARTEMediathek(Mediathek):
  ...
  def __init__(self, simpleXbmcGui):
	...
	TreeNode("1.0",u"28 Minuten",self.rootLink+"/guide/de/sendungen/VMI/28-minuten",True),
        TreeNode("1.1",u"360° - Geo",self.rootLink+"/guide/de/sendungen/TSG/360-geo-reportage",True),
        TreeNode("1.2",u"ARTE Journal",self.rootLink+"/guide/de/sendungen/AJT/arte-journal",True),
        TreeNode("1.3",u"ARTE Junior",self.rootLink+"/guide/de/sendungen/JUN/arte-junior",True),
        TreeNode("1.4",u"ARTE Reportage",self.rootLink+"/guide/de/sendungen/JTE/arte-reportage",True),
        TreeNode("1.5",u"Abgedreht",self.rootLink+"/guide/de/sendungen/PNB/abgedreht",True),
        TreeNode("1.6",u"Durch die Nacht mit …",self.rootLink+"/guide/de/sendungen/ACN/durch-die-nacht-mit",True),
        TreeNode("1.7",u"Futuremag",self.rootLink+"/guide/de/sendungen/FUM/futuremag",True),
        TreeNode("1.8",u"Karambolage",self.rootLink+"/guide/de/sendungen/KAR/karambolage",True),
        TreeNode("1.9",u"Kino auf ARTE",self.rootLink+"/guide/de/sendungen/FIL/kino-auf-arte",True),
        TreeNode("1.10",u"Kurzschluss",self.rootLink+"/guide/de/sendungen/COU/kurzschluss",True),
        TreeNode("1.11",u"Maestro",self.rootLink+"/guide/de/sendungen/MAE/maestro",True),
        TreeNode("1.12",u"Metropolis",self.rootLink+"/guide/de/sendungen/MTR/metropolis",True),
        TreeNode("1.13",u"Mit offenen Karten",self.rootLink+"/guide/de/sendungen/DCA/mit-offenen-karten",True),
        TreeNode("1.14",u"Philosophie",self.rootLink+"/guide/de/sendungen/PHI/philosophie",True),
        TreeNode("1.15",u"Square",self.rootLink+"/guide/de/sendungen/SUA/square",True),
        TreeNode("1.16",u"Tracks",self.rootLink+"/guide/de/sendungen/TRA/tracks",True),
        TreeNode("1.17",u"Vox Pop",self.rootLink+"/guide/de/sendungen/VOX/vox-pop",True),
        TreeNode("1.18",u"X:enius",self.rootLink+"/guide/de/sendungen/XEN/x-enius",True),
        TreeNode("1.19",u"Yourope",self.rootLink+"/guide/de/sendungen/YOU/yourope",True),
    ...
    self.regex_VideoPageLinksJSON = re.compile("\"url\":\"(\\\\/guide\\\\/de\\\\/\d{6}-\d{3}\\\\/.+?)\"");
